const update = () => {
  ...
  const element = [
    ...
    },
    {
      ...
      circle: document.querySelector(".box-1 .circle"),
    },
    {},
    {},
    {
  ...
  //
  setTimeout(() => {
    element[1].circle.style.opacity = 1;
    element[1].circle.style.scale = 1;
  }, 2000);
  //
  ...
  window.addEventListener("scroll", () => {
    ...
    for (let i = 0; i < section.length; i++) {
      if (
        yOffset > section[i].offsetTop - window.innerHeight / 2 &&
        yOffset <
          section[i].offsetTop -
